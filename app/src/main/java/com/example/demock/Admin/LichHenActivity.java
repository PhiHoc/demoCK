...
public class LichHenActivity extends AppCompatActivity {
    ...
    private EditText etId, etTen, etLichHen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThemLichHen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LichHen lichHen = new LichHen(id, ten, lich);
    ...
    private void onClickPushData(LichHen lichHen) {
        ...
        String pathObject = String.valueOf(lichHen.getId());
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                for (int i = 0; i < mListLichHen.size(); i++) {
                    if (lichHen.getId() == mListLichHen.get(i).getId()) {
    ...
    private void openDialogUpdateItem(LichHen lichHen) {
        ...
        btnCapNhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myRef.child(String.valueOf(lichHen.getId())).updateChildren(lichHen.toMap(), new DatabaseReference.CompletionListener() {
                    @Override
                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        myRef.child(String.valueOf(lichHen.getId())).removeValue(new DatabaseReference.CompletionListener() {
                            @Override
                            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
